...
const Footer = () => {
  return (
    <footer className="bg-primary dark:bg-green-950 text-white mt-16 transition-colors duration-300">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 md:py-12">
            ...
            <ul className="space-y-2">
              {[
                ...
                <li key={index}>
                  <Link
                    to={item.to}
                    className="text-gray-300 dark:text-gray-400 hover:text-secondary transition-colors duration-200 text-sm md:text-base block py-1"
                  >
                    {item.label}
                  </Link>
                </li>
        ...
        <div className="border-t border-gray-700 dark:border-gray-600 mt-6 md:mt-8 pt-6 md:pt-8 text-center">
